      ...
      <section className="py-16 bg-shrine-teal/10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-indigo-500 rounded-full p-4 mb-6">
              ...
              <h3 className="font-cinzel text-xl mb-2">Discord</h3>
              <p className="text-center text-gray-600 mb-4">Join our active community server</p>
              <span className="text-fox-orange font-medium">Join Now →</span>
            </a>
            ...
            >
              ...
              <h3 className="font-cinzel text-xl mb-2">Twitter</h3>
              <p className="text-center text-gray-600 mb-4">Daily updates and fox shenanigans</p>
              <span className="text-fox-orange font-medium">Follow →</span>
            </a>
            ...
            >
              ...
              <h3 className="font-cinzel text-xl mb-2">YouTube</h3>
              <p className="text-center text-gray-600 mb-4">Subscribe for VODs and highlights</p>
              <span className="text-fox-orange font-medium">Subscribe →</span>
            </a>
          </div>
        </div>
      </section>
