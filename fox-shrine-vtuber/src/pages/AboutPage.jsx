        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-16">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="w-full lg:w-1/2">
                <div className="bg-shrine-white p-6 rounded-lg shadow-lg">
                  <p className="text-center text-gray-500 italic">Character image will be displayed here</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 bg-shrine-white p-8 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-cinzel text-xl mb-2">Playful & Mischievous</h3>
                <p>Always ready with a joke or prank. Easily distracted by games and shiny objects!</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-cinzel text-xl mb-2">Curious & Energetic</h3>
                <p>Always exploring new games and asking questions. Bouncing with energy during streams!</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-cinzel text-xl mb-2">Caring & Loyal</h3>
                <p>Dedicated to my community and friends. Will always be there to cheer you up!</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="shrine-card mb-6">
                <h3 className="font-cinzel text-xl mb-2">What games do you play?</h3>
                <p>I love a variety of games! From cozy games like Animal Crossing and Stardew Valley to action-adventures and occasional horror games (though they make my fox tail puff up in fear!). I'm always open to suggestions from my community!</p>
              </div>
              
              <div className="shrine-card mb-6">
                <h3 className="font-cinzel text-xl mb-2">Can I send you fan art?</h3>
                <p>Absolutely! I love receiving fan art and showcase it regularly on stream and in my gallery. You can send it through my social media or post it with the tag #FoxShrineArt.</p>
              </div>
              
              <div className="shrine-card mb-6">
                <h3 className="font-cinzel text-xl mb-2">Do you do collaborations?</h3>
                <p>Yes! I enjoy collaborating with other content creators. You can reach out through my business email for serious inquiries. I'm particularly fond of collaborating with other shrine or animal-themed VTubers!</p>
              </div>
              
              <div className="shrine-card">
                <h3 className="font-cinzel text-xl mb-2">What's your favorite food?</h3>
                <p>Traditional shrine offerings like inarizushi (sweet tofu pouches) are my absolute favorite! I also have a weakness for strawberries and anything sweet. And yes, occasionally I might snack on chicken nuggets while no one is looking!</p>
              </div>
            </div>
          </section>
