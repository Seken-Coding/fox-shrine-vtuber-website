      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center mb-12 max-w-3xl mx-auto">
            Immerse yourself in the artistic world of Fox Shrine - featuring stunning fan creations 
            and official artwork that brings our magical universe to life.
          </p>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="shrine-card p-6 text-center group hover:scale-105 transition-transform duration-300">
          ...
          <section className="shrine-card p-8">
